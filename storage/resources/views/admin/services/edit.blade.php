             ...
             <form action="{{ url('service/'.$service->id ) }}" method="post" enctype="multipart/form-data">
                  ...
                  <div class="col-md-6">
                        <div class="form-group">
                                 ...
                                 <input type="text" class="form-control" id="title" name="name" value="{{old('name', $service->name)}}">
                ...
                <div class="col-md-6">
                  ...
                  <div class="col-md-12">
                     <div class="form-group">
                              ...
                              <input type="text" class="form-control" value="{{$service->free_consultation_desc}}" id="free_consultation_desc" placeholder="Enter Free Consultation" name="free_consultation_desc" value="{{old('free_consultation_desc')}}">
