<footer>
        ...
        <div class="row">
          <div class="col-lg-5 col-md-5 col-sm-12">
            <div class="suscribeNewsletter">
              ...
              <p>Stay updated with all the latest legal updates. <br> Just enter your email address and subscribe for free!</p>
            </div>
          </div>
  ...
  <div class="footer-nav-policyandsocial mt-5 mb-5">
    <div class="container-fluid">
      <div class="footer-policyandsocial-links">
        <div class="footer-policy-link">
          <ul>
            ...
            <li><a href="{{url('term-of-use')}}">Terms of services </a></li>
  ...
  <section>
    <div class="container-fluid footer-item-container" style="padding:0px 40px;">
      <div class="row">
...
<div class="footer-content">
  <div class="container-fluid pt-4">
    <div class="footer-content-main-div">
      ...
      <h3 class="overview-company-h3">Navigating Regulatory Affairs</h3>
      ...
      <h3 class="overview-company-h3">Safeguarding Intellectual Property</h3>
...
<!-- End Model -->
  ...
  <script src="{{asset('frontend/assets/js/whizseed.js')}}"></script>
...
$(document).ready(function() {
      ...
      $(".show-most-service").click(function(){

        if($(".search-bar").css('display')==='none'){
          $(".search-bar").css('display','block !important');
          $("#autosearch").focus();
          $(this).hide();
        }else{
  ...
  <script>
    $(".linevar").click(function(){
      if($(".library-section").css('display') == 'none'){
        $(".library-section").css('display','block');
      }else{
        $(".library-section").css('display','none');
      }
    });
  </script>
